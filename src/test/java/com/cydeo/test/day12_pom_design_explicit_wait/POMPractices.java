...
public class POMPractices {
    ...
    LibraryLoginPage libraryLoginPage;  // class level so we dont need to instantiate for every test
    ...
    public void invalid_email_format_error_Message(){
        ...
        libraryLoginPage.inputUsername.sendKeys("akshaacom");
        libraryLoginPage.signInButton.click();
    ...
    @Test
    public void library_negative_login() throws InterruptedException {
